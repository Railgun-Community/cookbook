...
export interface UniV2LikeFactoryInterface extends utils.Interface {
  functions: {
...
export interface UniV2LikeFactory extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: UniV2LikeFactoryInterface;
