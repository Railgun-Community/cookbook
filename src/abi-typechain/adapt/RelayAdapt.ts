...
export declare namespace RelayAdapt {
  ...
  export type TokenTransferStructOutput = [
    ...
    string,
    BigNumber,
  ] & { token: TokenDataStructOutput; to: string; value: BigNumber };
}
...
export interface RelayAdaptInterface extends utils.Interface {
  ...
  events: {
    'CallError(uint256,bytes)': EventFragment;
  };

  getEvent(nameOrSignatureOrTopic: 'CallError'): EventFragment;
}

export interface CallErrorEventObject {
  callIndex: BigNumber;
  revertReason: string;
}
export type CallErrorEvent = TypedEvent<
  [BigNumber, string],
  CallErrorEventObject
>;

export type CallErrorEventFilter = TypedEventFilter<CallErrorEvent>;
...
export interface RelayAdapt extends BaseContract {
  ...
  filters: {
    'CallError(uint256,bytes)'(
      callIndex?: null,
      revertReason?: null,
    ): CallErrorEventFilter;
    CallError(callIndex?: null, revertReason?: null): CallErrorEventFilter;
  };
