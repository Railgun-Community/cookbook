...
import { ZeroXV2Quote, type SwapQuoteDataV2 } from '../../../api/zero-x-v2';
...
const quote: SwapQuoteDataV2 = {
  ...
  zid: '111111111111111111',
};

let stub0xQuote: SinonStub;

describe('zero-x-v2-swap-recipe-public-destination', () => {
  before(() => {
    setRailgunFees(
      networkName,
      MOCK_SHIELD_FEE_BASIS_POINTS,
  ...
  it('Should create zero-x-v2-swap-recipe with amount and public destination address', async () => {
    const recipe = new ZeroXV2SwapRecipe(
      sellToken,
      buyToken,
      slippageBasisPoints,
