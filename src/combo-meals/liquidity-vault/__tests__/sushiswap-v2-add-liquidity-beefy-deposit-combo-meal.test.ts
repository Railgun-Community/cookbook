  ...
  it('Should create sushiswap-v2-add-liquidity-beefy-deposit-combo-meal', async () => {
      ...
      outputERC20Amounts: [
        {
          ...
          minBalance: BigNumber.from('0x1b68c982bfa2a000'),
          approvedSpender: undefined,
          isBaseToken: false,
      ...
      outputERC20Amounts: [
        {
          ...
          expectedBalance: BigNumber.from('0x1bafa9ee16e78000'),
          minBalance: BigNumber.from('0x1bafa9ee16e78000'), // TODO: Fix this: Actual minimum is lost from recipe output into combo.
          isBaseToken: false,
          tokenAddress: LP_TOKEN.tokenAddress,
          decimals: 18,
        },
    ...
    expect(output.stepOutputs[5]).to.deep.equal({
      ...
      outputERC20Amounts: [
        {
          approvedSpender: undefined,
          expectedBalance: BigNumber.from('0x1b6326c42440912b'),
          minBalance: BigNumber.from('0x1b6326c42440912b'),
      ...
      spentERC20Amounts: [
        {
          amount: BigNumber.from('0x1bafa9ee16e78000'),
          tokenAddress: LP_TOKEN.tokenAddress,
    ...
    expect(output.stepOutputs[6]).to.deep.equal({
      ...
      feeERC20AmountRecipients: [
        {
          amount: BigNumber.from('0x1187230ce4005c'),
      ...
      outputERC20Amounts: [
        {
          approvedSpender: undefined,
          expectedBalance: BigNumber.from('0x1b519fa1175c90cf'),
          minBalance: BigNumber.from('0x1b519fa1175c90cf'),
          tokenAddress: vault.vaultTokenAddress,
          isBaseToken: undefined,
          decimals: 18,
        },
