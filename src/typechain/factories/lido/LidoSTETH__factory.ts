...
import type { LidoSTETH, LidoSTETHInterface } from "../../lido/LidoSTETH";
...
export class LidoSTETH__factory {
  ...
  static createInterface(): LidoSTETHInterface {
    return new Interface(_abi) as LidoSTETHInterface;
  }
  static connect(address: string, runner?: ContractRunner | null): LidoSTETH {
    return new Contract(address, _abi, runner) as unknown as LidoSTETH;
  }
}
