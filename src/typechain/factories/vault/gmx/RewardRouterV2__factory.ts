...
import type {
  RewardRouterV2,
  RewardRouterV2Interface,
} from "../../../vault/gmx/RewardRouterV2";
...
export class RewardRouterV2__factory {
  static readonly abi = _abi;
  static createInterface(): RewardRouterV2Interface {
    return new Interface(_abi) as RewardRouterV2Interface;
  }
  static connect(
    address: string,
    runner?: ContractRunner | null
  ): RewardRouterV2 {
    return new Contract(address, _abi, runner) as unknown as RewardRouterV2;
  }
}
